...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapAddingsupplementation(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapComplianceHistoryThree(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.complianceHistorythreeScreen,
    );
  }

  onTapComplianceHistoryFour(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.complianceHistoryfourScreen,
    );
  }

  onTapComplianceHistoryFive(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.complianceHistoryfiveScreen,
    );
  }

  onTapComplianceHistorySix(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.complianceHistorysixScreen,
    );
  }
  ...
  onTapAndroidLargeTen(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.androidLargeTenScreen,
    );
  }

  onTapAndroidLargeEleven(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.androidLargeElevenScreen,
    );
  }

  onTapMedFinderOne(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.medFinderOneScreen,
    );
  }

  onTapMedFinderTwo(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.medFinderTwoScreen,
    );
  }

  onTapSideeffectscheckerOne(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.sideEffectsCheckeroneScreen,
    );
  }

  onTapSideeffectscheckerTwo(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapPersonalDataname(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.personalDataNameScreen,
    );
  }

  onTapPersonalDataemail(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.personalDataEMailScreen,
    );
  }
  ...
  onTapNotificationlist(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.notificationListScreen,
    );
  }

  onTapNotificationlistdelete(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.notificationListDeleteScreen,
    );
  }
